...
@section('content')
    ...
    <div class="container flex flex-col-reverse md:flex-row items-center px-6 mx-auto mt-10 space-y-0 md:space-y-0">
        <div class="flex flex-col mb-32 space-y-6 ml-20 md:w-1/2">
            ...
            {{-- <p class="max-w-sm text-center text-darkGrayishBlue mr-0 md:text-left">Maintaining blood stock inventory is tedious with laborious back-office paperwork and managing information on availability and shortage of blood is a tall task. <strong><span style="color:#cf3d3c">Red</span>Line</strong> is here to solve that.</p><br> --}}
            <div class="flex justify-center mt-5 md:justify-start">
                <button type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    <a href="{{ route('pages.request_blood') }}">Request for Blood</a>
                </button>
    ...
    <section class="text-gray-600 body-font">
      <div class="container px-5 py-0 mx-auto flex flex-wrap">
        <div class="mx-auto">
          <h1 class="max-w-md text-4xl font-bold text-center px-2 py-2 rounded-lg md:text-5xl md:text-left bg-red-600 text-white">How does it Work?</h1>
        </div>
